from .acceptor import SequenceAcceptor as SequenceAcceptor, StateMachineAcceptor as StateMachineAcceptor, TextAcceptor as TextAcceptor, TokenAcceptor as TokenAcceptor, WaitForAcceptor as WaitForAcceptor
from .json_acceptor import ArrayAcceptor as ArrayAcceptor, BooleanAcceptor as BooleanAcceptor, NullAcceptor as NullAcceptor, NumberAcceptor as NumberAcceptor, ObjectAcceptor as ObjectAcceptor, StringAcceptor as StringAcceptor, StringConstantAcceptor as StringConstantAcceptor, WhitespaceAcceptor as WhitespaceAcceptor, prepare_json_acceptor_tries as prepare_json_acceptor_tries
...
class JsonSchemaAcceptorDriver:
    ...
    @classmethod
    def driver_factory_for_model(cls, vocabulary: Iterable[tuple[int, str]], eos_id: int) -> callable: ...
    ...
    def __init__(self, vocabulary_dict: dict[int, str], vocabulary_trie: TokenTrie, eos_id: int, schema: dict, is_encapsulated_json: bool = False) -> None: ...
