...
class TokenAcceptor:
    ...
    @classmethod
    def debug_match_all(cls, cursors: Iterable[TokenAcceptor.Cursor], trie: TokenTrie, debug_output_fn=...) -> int: ...
    @classmethod
    def advance_all(cls, cursors: Iterable[TokenAcceptor.Cursor], char: str) -> list[TokenAcceptor.Cursor]: ...
    ...
    class Cursor:
        ...
        def debug_match(self, trie: TokenTrie, debug_output_fn=..., debug_indent: int = 1) -> int: ...
...
class StateMachineAcceptor(TokenAcceptor):
    ...
    def __init__(self, graph: Incomplete | None = None, initial_state: Incomplete | None = None, end_states: Incomplete | None = None) -> None: ...
